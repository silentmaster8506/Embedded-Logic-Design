...
HD_PWD='D:/ELD_final_prac/proj_one_div_1p5_plus_fft_x_sub_1p5/proj_one_div_1p5_plus_fft_x_sub_1p5.runs/fft_8pt_bd_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_8pt_bd_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_8pt_bd_floating_point_0_0.tcl
