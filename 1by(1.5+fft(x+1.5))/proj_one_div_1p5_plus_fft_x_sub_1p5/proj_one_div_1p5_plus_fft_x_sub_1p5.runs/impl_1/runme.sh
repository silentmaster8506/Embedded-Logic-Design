...
HD_PWD='D:/ELD_final_prac/proj_one_div_1p5_plus_fft_x_sub_1p5/proj_one_div_1p5_plus_fft_x_sub_1p5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_8pt_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_8pt_bd_wrapper.tcl -notrace
