...
#
# Generated by export_simulation on Thu Oct 02 22:31:14 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './fp_rec.sh' script.
...
./fp_rec.sh -noclean_files

For more information on the script, please type './fp_rec.sh -help'.
