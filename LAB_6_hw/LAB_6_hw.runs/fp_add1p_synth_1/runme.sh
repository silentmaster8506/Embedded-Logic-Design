...
HD_PWD='C:/Users/User/Desktop/ELD LAB/LAB_6_hw/LAB_6_hw.runs/fp_add1p_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_add1p.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_add1p.tcl
