...
HD_PWD='C:/Users/User/Desktop/ELD LAB/LAB_6_hw/LAB_6_hw.runs/fp_rec_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_rec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_rec.tcl
