...
HD_PWD='C:/Users/User/Desktop/ELD LAB/LAB_7_cur/LAB_7_cur.runs/splitter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log splitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source splitter.tcl
