...
HD_PWD='C:/Users/User/Desktop/ELD LAB/ak/ak.runs/floating_point_root_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_root.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_root.tcl
