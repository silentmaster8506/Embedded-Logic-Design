...
connect_bd_intf_net -intf_net [get_bd_intf_nets floating_point_1_M_AXIS_RESULT] [get_bd_intf_pins floating_point_1/M_AXIS_RESULT] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins floating_point_0/s_axis_b_tvalid] [get_bd_pins xfft_0/s_axis_config_tvalid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xfft_0/s_axis_config_tdata] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins floating_point_0/s_axis_b_tdata] [get_bd_pins xlconstant_2/dout]
