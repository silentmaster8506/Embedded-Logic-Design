...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/endsem/endsem.runs/fft_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_auto_pc_0.tcl
