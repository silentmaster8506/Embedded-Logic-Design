...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/endsem/endsem.runs/fft_floating_point_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_floating_point_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_floating_point_1_0.tcl
