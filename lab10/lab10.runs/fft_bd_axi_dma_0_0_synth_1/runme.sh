...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/lab10/lab10.runs/fft_bd_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_bd_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_bd_axi_dma_0_0.tcl
