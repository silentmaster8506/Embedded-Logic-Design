...
#
# Generated by export_simulation on Wed Nov 05 22:39:14 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './bd_fft.sh' script.
...
./bd_fft.sh -noclean_files

For more information on the script, please type './bd_fft.sh -help'.
