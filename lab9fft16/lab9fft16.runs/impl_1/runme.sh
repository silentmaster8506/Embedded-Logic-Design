...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/lab9fft16/lab9fft16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fft_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_fft_wrapper.tcl -notrace
