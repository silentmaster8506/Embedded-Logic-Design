...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/lab9fft16/lab9fft16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fft_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_fft_wrapper.tcl
