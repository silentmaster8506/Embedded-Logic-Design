...
#
# Generated by export_simulation on Thu Oct 09 22:16:05 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './splitter.sh' script.

./splitter.sh -reset_run
...
./splitter.sh -noclean_files

For more information on the script, please type './splitter.sh -help'.
