...
simulate()
{
  xsim fft_bd -key {Behavioral:sim_1:Functional:fft_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a8ca.protoinst" -protoinst "protoinst_files/fft_bd.protoinst" -log simulate.log
}
