...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/practice_lab/practice_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prac_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prac_bd_wrapper.tcl -notrace
