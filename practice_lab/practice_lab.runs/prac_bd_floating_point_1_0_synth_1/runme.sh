...
HD_PWD='C:/Desktop/Coding/Verilog/practice_lab/practice_lab.runs/prac_bd_floating_point_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prac_bd_floating_point_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prac_bd_floating_point_1_0.tcl
