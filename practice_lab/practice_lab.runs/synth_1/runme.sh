...
HD_PWD='C:/Users/User/Desktop/ELD_LAB/practice_lab/practice_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prac_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prac_bd_wrapper.tcl
